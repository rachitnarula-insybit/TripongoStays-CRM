        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-600">
              AI-powered actions to optimize performance
            </p>
          </div>
        </div>
                    ...
                    <div className="flex items-start gap-3 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 text-xs">
                          <span className={cn('px-2 py-1 rounded-full', typeConfig_.color.replace('from-', 'bg-').replace(' to-emerald-500', '').replace(' to-cyan-500', '').replace(' to-pink-500', '').replace(' to-red-500', '').replace('500', '100'), 'text-neutral-700')}>
                            {typeConfig_.label}
                          </span>
                    ...
                    {isSelected && (
                      ...
                      >
                        ...
                        <div className="p-3 rounded-lg bg-gradient-to-r from-blue-500/5 to-cyan-500/5 border border-blue-500/20">
                          ...
                          <p className="text-sm text-neutral-600">
                            This recommendation is based on analysis of similar patterns in high-performing accounts. 
                            The confidence score reflects the likelihood of achieving the projected impact.
                          </p>
                        </div>
                      </motion.div>
                    )}
